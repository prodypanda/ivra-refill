...
## Unreleased
- Updated safe package dependencies (firebase_core, firebase_messaging, supabase_flutter, google_fonts, local_auth, mobile_scanner, posix, realtime_client, uuid, objective_c, passkeys_platform_interface).
