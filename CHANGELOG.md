...
## Unreleased
- Updated safe package dependencies (firebase_core, firebase_messaging, google_fonts, home_widget, local_auth, mobile_scanner, supabase_flutter, uuid, workmanager).
