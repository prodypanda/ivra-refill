...
import 'operations_analytics_panel.dart';
              ...
              AnimatedSwitcher(
                ...
                child: refillEventsAsync.when(
                  ...
                  error: (err, stack) => SizedBox(
                    key: const ValueKey('chart_error'),
                    height: 220,
                    child: Center(
                      child: Text(
                        'Error: $err',
                    ...
                    switch (_dateRange) {
                      case ChartDateRange.last7Days:
                        ...
                        spots = List.generate(
                            7,
                            (i) => FlSpot(
                                i.toDouble(), dailyCounts[i].toDouble()));
                        ...
                        xLabels =
                            dates.map((d) => days[d.weekday - 1]).toList();
                        break;
