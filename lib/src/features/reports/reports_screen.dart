  ...
  Widget build(BuildContext context) {
    ...
    return PageScaffold(
      ...
      child: AnimatedSwitcher(
        ...
        child: isLoading && events.isEmpty && hotels.isEmpty
...
class _ReportsShimmer extends StatelessWidget {
  const _ReportsShimmer({super.key});

  @override
  Widget build(BuildContext context) {
    return Column(
      key: const ValueKey('reports_shimmer'),
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
            ...
            children: [
              ...
              Wrap(
                ...
                children: List.generate(
                    4,
                    (_) =>
                        const SizedBox(width: 190, child: MetricCardShimmer())),
              ),
              const SizedBox(height: 16),
