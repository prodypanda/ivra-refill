      ...
      child: AsyncValueView(
        ...
        builder: (data) {
          ...
          if (roles.isEmpty || permissions.isEmpty) {
             return Center(child: Text(AppLocalizations.of(context)!.t('rolePermissionsEmpty')));
          }
          ...
          return Card(
            ...
            child: SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columnSpacing: 24,
                columns: [
                  DataColumn(label: Text(AppLocalizations.of(context)!.t('rolePermissionsFeatureLabel'), style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.bold))),
