      ...
      child: AsyncValueView(
        ...
        builder: (data) {
          ...
          if (roles.isEmpty || permissions.isEmpty) {
             return Center(child: Text(AppLocalizations.of(context)!.t('rolePermissionsNoPermissionsFound')));
          }
          ...
          return Card(
            ...
            child: SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columnSpacing: 24,
                columns: [
                  DataColumn(label: Text(AppLocalizations.of(context)!.t('rolePermissionsFeatureColumn'), style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.bold))),
