      ...
      child: AsyncValueView(
        ...
        builder: (data) {
          ...
          if (roles.isEmpty || permissions.isEmpty) {
             return const Center(child: Text(AppLocalizations.of(context)!.t('settingsNoPermissionsFound')));
          }
          ...
          return Card(
            ...
            child: SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columnSpacing: 24,
                columns: [
                  DataColumn(label: Text(AppLocalizations.of(context)!.t('settingsFeatureColumn'), style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.bold))),
