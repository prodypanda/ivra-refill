                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(l10n.t('whatsNewLabel'), style: theme.textTheme.headlineSmall),
                          IconButton(
                      ...
                      Text(l10n.tParams('currentVersionLabel', {'appVersion': appVersion}), style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.primary)),
