                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(AppLocalizations.of(context)!.t('settingsWhatsNewTitle'), style: theme.textTheme.headlineSmall),
                          IconButton(
                      ...
                      Text(AppLocalizations.of(context)!.tParams('settingsCurrentVersion', {'appVersion': appVersion.toString()}), style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.primary)),
