...
abstract class AppL10n {
  ...
  /// No description provided for @authNoPermissionsFound.
  ///
  /// In en, this message translates to:
  /// **'No permissions found.'**
  String get authNoPermissionsFound;

  /// No description provided for @authFeatureHeader.
  ///
  /// In en, this message translates to:
  /// **'Feature'**
  String get authFeatureHeader;

  /// No description provided for @settingsWhatsNewHeader.
  ///
  /// In en, this message translates to:
  /// **'What\'s New'**
  String get settingsWhatsNewHeader;
