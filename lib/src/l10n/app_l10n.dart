...
abstract class AppL10n {
  ...
  /// No description provided for @rolePermissionsNoneFound.
  ///
  /// In en, this message translates to:
  /// **'No permissions found.'**
  String get rolePermissionsNoneFound;

  /// No description provided for @rolePermissionsFeatureCol.
  ///
  /// In en, this message translates to:
  /// **'Feature'**
  String get rolePermissionsFeatureCol;
