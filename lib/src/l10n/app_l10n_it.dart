...
class AppL10nIt extends AppL10n {
  ...
  @override
  String get appThemeStyle => 'Tema e stile visivo';

  @override
  String get appThemeStyleSubtitle =>
      'Aspetto globale per tutto il personale e i manager su tutti i dispositivi';

  @override
  String get themeSolarInfusion => 'Infusione Solare';

  @override
  String get themeSolarInfusionDesc =>
      'Calda tavolozza di ambra mediterranea e crema solare con tipografia Plus Jakarta Sans.';

  @override
  String get themeBotanicalHaute => 'Alta Botanica';

  @override
  String get themeBotanicalHauteDesc =>
      'Tavolozza di lusso smeraldo di mezzanotte e alabastro puro con tipografia architettonica Outfit.';

  @override
  String get themeActive => 'Attivo';

  @override
  String themeSwitchSuccess(String themeName) {
    return 'Tema dell\'app modificato a livello globale in $themeName';
  }

  @override
  String get percentageRefillTitle => 'Ricarica in percentuale';

  @override
  String get percentageRefillSubtitle =>
      'Consenti la registrazione dei livelli di ricarica in percentuale (1-100%)';
  ...
  @override
  String get housekeeperStockHistory => 'Cronologia';
  ...
  @override
  String get stockEventCheckout => 'Prelevato dall\'inventario dell\'hotel';

  @override
  String get stockEventReturn => 'Restituito all\'inventario dell\'hotel';

  @override
  String get stockEventRoomPlacement => 'Posizionato in camera';

  @override
  String get stockEventRefillUse => 'Usato per la ricarica';

  @override
  String get stockEventReplaceUse =>
      'Usato per la sostituzione della bottiglia';

  @override
  String housekeeperHotelStockAvailable(String bottles, String bidons) {
    return 'Inventario hotel: $bottles bottiglie piene, $bidons bidoni pieni disponibili';
  }

  @override
  String get sourceHousekeeperCart => 'Dal carrello della cameriera';

  @override
  String get sourceHotelInventory => 'Dall\'inventario dell\'hotel';
