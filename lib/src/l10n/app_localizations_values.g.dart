...
const Map<String, Map<String, String>> kL10nValues = {
  ...
  'ar': {
    ...
    'teamInvitationCancelled': 'تمإ إلغاء الدعوة لـ {email}',
    'teamInvitationResent': 'تمت إعادة إرسؤل الدعوة إلى {email}',
    ...
    'alertsEmptyMessage': 'حدّث التنبيهات الذكيّة لفحص المخزون وحدود إعادة إالتعبئة وعمر الزجاجات والموافقات المىعلّقة.',
    ...
    'inviteEmailMismatch': 'استدخدم عنوان البريد الإلكتروني الذي أُرسلت إليه هذه الدعوة.',
