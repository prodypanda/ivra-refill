...
const Map<String, Map<String, String>> kL10nValues = {
  'en': {
    ...
    'inventoryEnforceTemplateContent': 'Placing {total} bottle(s) of {product} requires stock. Inventory only has {current}. Would you like to automatically add {needed} bottle(s) to the inventory and proceed?',
    'inventoryEnforceReplaceContent': 'Replacing the bottle of {product} in Room {room} requires 1 full bottle. Inventory has 0. Would you like to automatically add 1 bottle to the inventory and proceed?',
    ...
    'inventoryEnforceOnboardingTitle': 'Initialize Inventory',
    'inventoryEnforceOnboardingContent': 'Since this is a new hotel, there are no products in the inventory. Would you like to automatically initialize the inventory with {total} bottles to place in the rooms?',
  },
  'fr': {
    ...
    'inventoryEnforceTemplateContent': 'Placer {total} bouteille(s) de {product} nécessite du stock. L\'inventaire n\'en a que {current}. Souhaitez-vous ajouter automatiquement {needed} bouteille(s) à l\'inventaire et continuer?',
    'inventoryEnforceReplaceContent': 'Remplacer la bouteille de {product} dans la chambre {room} nécessite 1 bouteille pleine. L\'inventaire en a 0. Souhaitez-vous ajouter automatiquement 1 bouteille à l\'inventaire et continuer?',
    ...
    'inventoryEnforceOnboardingTitle': 'Initialiser l\'inventaire',
    'inventoryEnforceOnboardingContent': 'Puisqu\'il s\'agit d\'un nouvel hôtel, il n\'y a aucun produit dans l\'inventaire. Souhaitez-vous initialiser automatiquement l\'inventaire avec {total} bouteilles à placer dans les chambres?',
  },
  'ar': {
    ...
    'productHistoryAdjustment': 'تعديل المخزون يدويًا',
    ...
    'inventoryEnforceTitle': 'مخزون غير كافٍ',
    'inventoryEnforceTemplateContent': 'وضع {total} زجاجة (زجاجات) من {product} يتطلب مخزونًا. يحتوي المخزون فقط على {current}. هل ترغب في إضافة {needed} زجاجة (زجاجات) تلقائيًا إلى المخزون والمتابعة؟',
    'inventoryEnforceReplaceContent': 'استبدال زجاجة {product} في الغرفة {room} يتطلب زجاجة ممتلئة واحدة. المخزون يحتوي على 0. هل ترغب في إضافة زجاجة واحدة تلقائيًا إلى المخزون والمتابعة؟',
    ...
    'inventoryEnforceOnboardingTitle': 'تهيئة المخزون',
    'inventoryEnforceOnboardingContent': 'بما أن هذا فندق جديد، فلا توجد منتجات في المخزون. هل ترغب في تهيئة المخزون تلقائيًا بـ {total} زجاجة لوضعها في الغرف؟',
  },
  'it': {
    ...
    'inventoryEnforceTemplateContent': 'Posizionare {total} bottiglia/e di {product} richiede scorte. L\'inventario ha solo {current}. Vuoi aggiungere automaticamente {needed} bottiglia/e all\'inventario e procedere?',
    'inventoryEnforceReplaceContent': 'Sostituire la bottiglia di {product} in Camera {room} richiede 1 bottiglia piena. L\'inventario ha 0. Vuoi aggiungere automaticamente 1 bottiglia all\'inventario e procedere?',
    ...
    'inventoryEnforceOnboardingTitle': 'Inizializza inventario',
    'inventoryEnforceOnboardingContent': 'Trattandosi di un nuovo hotel, non ci sono prodotti in inventario. Vuoi inizializzare automaticamente l\'inventario con {total} bottiglie da posizionare nelle camere?',
  },
};
