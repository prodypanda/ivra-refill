...
//
// Regenerate with: python tooling/sync_arb_to_g_dart.py
//
...
const Map<String, Map<String, String>> kL10nValues = {
  'en': {
    ...
    'appThemeStyle': 'App Theme & Visual Style',
    'appThemeStyleSubtitle': 'Global appearance for all staff and managers across all devices',
    'themeSolarInfusion': 'Solar Infusion',
    'themeSolarInfusionDesc': 'Warm Mediterranean amber and sunlit cream palette with Plus Jakarta Sans typography.',
    'themeBotanicalHaute': 'Botanical Haute',
    'themeBotanicalHauteDesc': 'Awwwards-level luxury midnight emerald and crisp alabaster palette with Outfit architectural typography.',
    'themeActive': 'Active',
    'themeSwitchSuccess': 'App theme globally updated to {themeName}',
    'percentageRefillTitle': 'Percentage Refill',
    'percentageRefillSubtitle': 'Allow recording refill levels as percentages (1-100%)',
    'expressQrTitle': 'Express QR Management',
    'expressQrSubtitle': 'Allow direct scanning of dispenser-level QR codes',
    ...
    'myCompletedTasksThisWeek': 'My Completed Refills This Week',
    ...
    'inventoryTableFullBottlesWithPump': 'Full {size} bottles with pump',
    'inventoryTableFullBottlesWithoutPump': 'Full {size} bottles without pump',
    ...
    'inventoryTableFullBidonsGeneric': 'Full refill bottles',
    'inventoryTableOpenBidons': 'Used refill bottles',
    ...
    'bottleStatusRefilled': 'Refilled',
    'bottleStatusRefillLimitReached': 'Refill limit reached',
    'bottleStatusTooOld': 'Too old',
    'bottleStatusNeedsReplacement': 'Needs replacement',
    'bottleStatusRecycled': 'Recycled',
    'bottleStatusDamaged': 'Damaged',
    'bottleStatusLost': 'Lost',
    ...
    'roomsBtnRefillBottle': 'Refill bottle',
    'roomsBtnRoomEdit': 'Room edit',
    'roomsBtnHistory': 'History',
    'roomsBtnMoreActions': 'More actions',
    'roomsBtnMarkDamaged': 'Mark as Damaged',
    'roomsBtnMarkLost': 'Mark as Lost',
    'roomsLabelProofPhoto': 'Proof Photo',
    'roomsNotesOptional': 'Notes (Optional)',
    'roomsLabelUploadedProof': 'Uploaded Proof',
    'roomsUploadProofAction': 'Upload Photo',
    ...
    'roomsGestionExpressQr': 'Express QR Management',
    'roomsGestionQr': 'QR Code Management',
    ...
    'roomsHistoryStatusChanged': 'Status changed from {oldValue} to {newValue}',
    'roomsFilterAll': 'All',
    ...
    'btnBack': 'Back',
    'qrActionSuccess': 'Action Successful',
    'qrActionFailed': 'Action Failed',
    'qrUpdatedStatus': 'Updated Dispenser Status:',
    'qrScanAnother': 'Scan another QR code',
    'qrReturnRooms': 'Return to rooms',
    'qrTryScanAgain': 'Try scanning again',
    'qrFloorRoom': 'Floor {floor} • Room {room}',
    'qrRoomFloor': 'Room {room} • Floor {floor}',
    ...
    'qrGenerateScope': 'QR Label Type',
    'qrGenerateScopeRoom': 'Room Door (No SKU)',
    'qrGenerateScopeDispenser': 'Dispenser (With SKU)',
    'qrGenerateRoom': 'Room',
    'qrGenerateProduct': 'Product',
    'qrGenerateAllRooms': 'All Rooms',
    'qrGenerateAllProducts': 'All Products',
    'qrGenerateBtnDownload': 'Generate & Download PDF',
    'qrGenerateDownloading': 'Generating PDF...',
    ...
    'qrGenAllRoomProducts': 'All products in the selected room',
    'qrGenAllInventoryProducts': 'All products in the inventory',
    'qrLabelScanInstructions': 'Scan with IVRA app to refill or replace',
    ...
    'pdfTitleInventorySnapshot': 'Ivra Store Stock Snapshot',
    'pdfTitleRefillHistory': 'Ivra Refill History',
    'pdfTitleOpenAlerts': 'Ivra Open Alerts',
    'productHistoryTitle': 'Product History',
    'productHistoryNoHistory': 'No history recorded for this product.',
    'productHistoryRefill': 'Refilled in Room {roomNumber}',
    'productHistoryReplacement': 'Replaced bottle in Room {roomNumber}',
    'productHistoryAdjustment': 'Manual Stock Adjustment',
    'productHistoryActionBy': 'By {user}',
    'productHistoryReason': 'Reason: {reason}',
    'productHistoryDeltaFullBottles': 'Full bottles',
    'productHistoryDeltaUsedBottles': 'Used bottles',
    'productHistoryDeltaFullBidons': 'Full refill bottles',
    'productHistoryDeltaOpenBidons': 'Opened refill bottles',
    'productHistoryDeltaEmptyBidons': 'Empty refill bottles',
    'productHistoryNewBottle': 'New bottle placed in Room {roomNumber}',
    'productHistoryFilterAll': 'All',
    'productHistoryFilterRoom': 'Room Events',
    'productHistoryFilterManual': 'Adjustments',
    'productHistoryStatRefills': 'Refills',
    ...
    'authCategoryCore': 'Core Operations',
    'authCategoryManagement': 'Management',
    'authCategoryControl': 'Control & Approvals',
    'authCategoryAnalytics': 'Analytics & Broadcasts',
    'authCategorySecurity': 'Security & Administration',
    'authBulkGrantAll': 'Grant All',
    'authBulkRevokeAll': 'Revoke All',
    'authRoleCreatedSuccess': 'Role created successfully.',
    ...
    'roleHotelManager': 'Hotel Manager',
    'roleHotelStaff': 'Hotel Staff',
    'permManageHotels': 'Manage Hotels',
    'permManageHotelsDesc': 'Create, edit, and delete hotel properties',
    'permManageRooms': 'Manage Rooms',
    'permManageRoomsDesc': 'Add, edit, and remove rooms and floors',
    'permManageProducts': 'Manage Products',
    'permManageProductsDesc': 'Configure global product types and catalogs',
    ...
    'permViewAlertsDesc': 'View and monitor operation alerts',
    'permViewReports': 'View Reports',
    'permViewReportsDesc': 'Access analytics reports and performance charts',
    ...
    'dialogRefillAdded': 'To Add:',
    'dialogRefillNotes': 'Notes (optional)',
    'dialogRefillConfirm': 'Confirm Refill',
    'femmeDeChambre': 'Housekeeper',
    'checkoutStock': 'Checkout Stock',
    'returnStock': 'Return Stock',
    'housekeeperCart': 'My Cart',
    'noAllocations': 'No active allocations. Check out stock to start.',
    'fullBottles': 'Full Bottles',
    'openBidonVolumeLeft': 'Remaining Volume',
    ...
    'roomsSelectProduct': 'Select Product',
    'myBasket': 'My Basket',
    'housekeepersTitle': 'Housekeepers',
    'allHistory': 'All history',
    'changePicture': 'Change picture',
    'inviteHousekeeper': 'Invite housekeeper',
    'removeHousekeeper': 'Remove housekeeper',
    'basketContent': 'Basket content',
    'noHousekeepers': 'No housekeepers found',
    'btnClose': 'Close',
    'deleteGeneric': 'Delete',
    'teamDeactivate': 'Deactivate',
    'teamReactivate': 'Reactivate',
    'event_checkout': 'Stock Checked Out',
    'event_returned': 'Stock Returned',
    'event_roomPlacement': 'Placed in Room',
    'event_refillUse': 'Refill Used',
    'event_replaceUse': 'Bottle Replaced',
    'dialogRefillNotesHint': 'e.g. standard refill...',
    'dateFormatHint': 'YYYY-MM-DD',
    'errorWithArgs': 'Error: {error}',
    'teamHotelSubtitle': '{city}, {country}',
    'productEventTitle': '{productName} - {eventLabel}',
    'chipLabelValue': '{label}: {value}',
    'productSkuLabel': '{label} ({sku})',
  ...
  'fr': {
    ...
    'appThemeStyle': 'Thème et style visuel',
    'appThemeStyleSubtitle': 'Apparence globale pour tous les utilisateurs sur tous les appareils',
    'themeSolarInfusion': 'Infusion Solaire',
    'themeSolarInfusionDesc': 'Palette chaude d\'ambre méditerranéen et crème ensoleillée avec typographie Plus Jakarta Sans.',
    'themeBotanicalHaute': 'Haute Botanique',
    'themeBotanicalHauteDesc': 'Palette de luxe émeraude minuit et albâtre pur avec typographie architecturale Outfit.',
    'themeActive': 'Actif',
    'themeSwitchSuccess': 'Le thème de l\'application a été changé mondialement en {themeName}',
    'percentageRefillTitle': 'Recharge en pourcentage',
    'percentageRefillSubtitle': 'Autoriser l\'enregistrement des niveaux de recharge en pourcentage (1-100%)',
    ...
    'myCompletedTasksThisWeek': 'Mes recharges terminées cette semaine',
    ...
    'inventoryTableFullBidonsGeneric': 'Bouteilles de recharge pleines',
    'inventoryTableOpenBidons': 'Bouteilles de recharge usagées',
    ...
    'bottleStatusRefilled': 'Rechargée',
    'bottleStatusRefillLimitReached': 'Limite de recharge atteinte',
    'bottleStatusTooOld': 'Trop ancienne',
    'bottleStatusNeedsReplacement': 'À remplacer',
    'bottleStatusRecycled': 'Recyclée',
    'bottleStatusDamaged': 'Endommagée',
    'bottleStatusLost': 'Perdue',
    ...
    'roomsBtnRefillBottle': 'Remplir la bouteille',
    'roomsBtnRoomEdit': 'Modifier la chambre',
    'roomsBtnHistory': 'Historique',
    'roomsBtnMoreActions': 'Plus d\'actions',
    'roomsBtnMarkDamaged': 'Marquer comme endommagé',
    'roomsBtnMarkLost': 'Marquer comme perdu',
    'roomsLabelProofPhoto': 'Photo de preuve',
    ...
    'btnBack': 'Retour',
    'qrActionSuccess': 'Action réussie',
    'qrActionFailed': 'Échec de l\'action',
    'qrUpdatedStatus': 'État du distributeur mis à jour :',
    'qrScanAnother': 'Scanner un autre code QR',
    'qrReturnRooms': 'Retour aux chambres',
    'qrTryScanAgain': 'Réessayer le scan',
    'qrFloorRoom': 'Étage {floor} • Chambre {room}',
    'qrRoomFloor': 'Chambre {room} • Étage {floor}',
    ...
    'qrGenerateScope': 'Type d\'étiquette QR',
    'qrGenerateScopeRoom': 'Porte de chambre (sans SKU)',
    'qrGenerateScopeDispenser': 'Distributeur (avec SKU)',
    'qrGenerateRoom': 'Chambre',
    'qrGenerateProduct': 'Produit',
    'qrGenerateAllRooms': 'Toutes les chambres',
    'qrGenerateAllProducts': 'Tous les produits',
    'qrGenerateBtnDownload': 'Générer & Télécharger le PDF',
    'qrGenerateDownloading': 'Génération du PDF...',
    ...
    'pdfTitleInventorySnapshot': 'Stock magasin Ivra',
    ...
    'productHistoryDeltaFullBottles': 'Bouteilles pleines',
    'productHistoryDeltaUsedBottles': 'Bouteilles utilisées',
    ...
    'productHistoryStatRefills': 'Recharges',
    ...
    'authCategoryManagement': 'Gestion',
    'authCategoryControl': 'Contrôle & Approbations',
    'authCategoryAnalytics': 'Analyses & Diffusions',
    'authCategorySecurity': 'Sécurité & Administration',
    'authBulkGrantAll': 'Tout Accorder',
    'authBulkRevokeAll': 'Tout Révoquer',
    'authRoleCreatedSuccess': 'Rôle créé avec succès.',
    ...
    'dialogRefillAdded': 'Liquide nouvellement ajouté :',
    'dialogRefillNotes': 'Notes (optionnel)',
    'dialogRefillConfirm': 'Confirmer la recharge',
    ...
    'roomsSelectProduct': 'Sélectionner un produit',
    'myBasket': 'Mon Chariot',
    'housekeepersTitle': 'Femmes de Chambre',
    'allHistory': 'Tout l\'historique',
    'changePicture': 'Changer la photo',
    'inviteHousekeeper': 'Inviter une femme de chambre',
    'removeHousekeeper': 'Supprimer',
    'basketContent': 'Contenu du chariot',
    'noHousekeepers': 'Aucune femme de chambre trouvée',
    'btnClose': 'Fermer',
    'deleteGeneric': 'Supprimer',
    'teamDeactivate': 'Désactiver',
    'teamReactivate': 'Réactiver',
    'event_checkout': 'Stock Récupéré',
    'event_returned': 'Stock Retourné',
    'event_roomPlacement': 'Placé en Chambre',
    'event_refillUse': 'Utilisé pour Recharger',
    'event_replaceUse': 'Bouteille Remplacée',
    'dialogRefillNotesHint': 'ex: recharge standard...',
    'dateFormatHint': 'AAAA-MM-JJ',
    'errorWithArgs': 'Erreur : {error}',
    'teamHotelSubtitle': '{city}, {country}',
    'productEventTitle': '{productName} - {eventLabel}',
    'chipLabelValue': '{label} : {value}',
    'productSkuLabel': '{label} ({sku})',
  ...
  'ar': {
    ...
    'appThemeStyle': 'سمة ونمط التطبيق المرئي',
    'appThemeStyleSubtitle': 'المظهر العام لجميع الموظفين والمديرين عبر جميع الأجهزة',
    'themeSolarInfusion': 'سولار إنفيوجن (الدفء الذهبي)',
    'themeSolarInfusionDesc': 'لوحة كهرمانية دافئة وكريم مشمس مع خط بلس جاكرتا سانس.',
    'themeBotanicalHaute': 'بوتانيكال هوت (الزمرد الفاخر)',
    'themeBotanicalHauteDesc': 'لوحة فاخرة من الزمرد الليلي والألباستر النقي مع خط أوتفيت المعماري.',
    'themeActive': 'مفعّل',
    'themeSwitchSuccess': 'تم تغيير سمة التطبيق عالمياً إلى {themeName}',
    'percentageRefillTitle': 'إعادة التعبئة بالنسبة المئوية',
    'percentageRefillSubtitle': 'السماح بتسجيل مستويات التعبئة كنسب مئوية (1-100%)',
    'expressQrTitle': 'الإدارة السريعة (QR)',
    'expressQrSubtitle': 'السماح بالمسح المباشر لرموز QR الخاصة بالموزع',
    ...
    'openSpecificPage': 'فتح صفحة محددة (اختيا��ي)',
    ...
    'dashboardUsageByFloor': 'الاست��دام حسب الطابق',
    'dashboardStockForecast': 'توقعات نفاد مخزون المتجر',
    'dashboardUnusualPatterns': 'أنماط غير عادية',
    'dashboardNoStockData': 'لا توجد بيانات مخزون المتجر',
    ...
    'myCompletedTasksThisWeek': 'عمليات إعادة التعبئة المكتملة لي هذا الأسبوع',
    ...
    'metricLowStockProducts': 'منتجات منخفضة مخزون المتجر',
    'inventoryTableProduct': 'المنتج',
    'inventoryTableFullBottles': 'العبوات الممتلئة',
    'inventoryTableFullBottlesWithPump': 'عبوات ممتلئة بمضخة سعة {size}',
    'inventoryTableFullBottlesWithoutPump': 'عبوات ممتلئة بدون مضخة سعة {size}',
    ...
    'inventoryTableFullBidonsGeneric': 'عبوات إعادة تعبئة ممتلئة',
    'inventoryTableOpenBidons': 'قوارير إعادة التعبئة المستعملة',
    ...
    'bottleStatusNeedsRefill': 'بحاجة لإعادة التعبئة',
    'bottleStatusRefilled': 'تمت إعادة التعبئة',
    'bottleStatusRefillLimitReached': 'تم الوصول لحد التعبئة',
    'bottleStatusTooOld': 'قديمة جداً',
    'bottleStatusNeedsReplacement': 'بحاجة للاستبدال',
    'bottleStatusRecycled': 'معاد تدويرها',
    'bottleStatusDamaged': 'تالفة',
    'bottleStatusLost': 'مفقودة',
    ...
    'roomsBtnRefillBottle': 'إعادة تعبئة العبوة',
    'roomsBtnRoomEdit': 'تعديل الغرفة',
    'roomsBtnHistory': 'السجل',
    'roomsBtnMoreActions': 'مزيد من الإجراءات',
    'roomsBtnMarkDamaged': 'تحديد كتالف',
    'roomsBtnMarkLost': 'تحديد كمفقود',
    'roomsLabelProofPhoto': 'صورة الإثبات',
    'roomsNotesOptional': 'ملاحظات (اختياري)',
    'roomsLabelUploadedProof': 'الإثبات المرفوع',
    'roomsUploadProofAction': 'رفع صورة',
    ...
    'roomsGestionExpressQr': 'الإدارة السريعة (QR)',
    'roomsGestionQr': 'إدارة رموز QR',
    ...
    'roomsHistoryStatusChanged': 'تغيرت الحالة من {oldValue} إلى {newValue}',
    'roomsFilterAll': 'الكل',
    ...
    'qrAccessDeniedMessage': 'ليس لديك صلاحية لتنفيذ إجراءات في هذا الفندق.',
    'roomsFillCount': 'عدد مرات التعبئة',
    'roomsBottleStatus': 'حالة الموزع',
    'btnBack': 'رجوع',
    'qrActionSuccess': 'تمت العملية بنجاح',
    'qrActionFailed': 'فشلت العملية',
    'qrUpdatedStatus': 'حالة الموزع المحدّثة:',
    'qrScanAnother': 'مسح رمز QR آخر',
    'qrReturnRooms': 'العودة إلى الغرف',
    'qrTryScanAgain': 'أعد المسح مرة أخرى',
    'qrFloorRoom': 'الطابق {floor} • الغرفة {room}',
    'qrRoomFloor': 'الغرفة {room} • الطابق {floor}',
    ...
    'qrGenerateScope': 'نوع ملصق QR',
    'qrGenerateScopeRoom': 'باب الغرفة (بدون SKU)',
    'qrGenerateScopeDispenser': 'الموزع (مع SKU)',
    'qrGenerateRoom': 'الغرفة',
    'qrGenerateProduct': 'المنتج',
    'qrGenerateAllRooms': 'جميع الغرف',
    'qrGenerateAllProducts': 'جميع المنتجات',
    'qrGenerateBtnDownload': 'توليد وتنزيل PDF',
    'qrGenerateDownloading': 'جاري توليد PDF...',
    'qrGenerateSuccess': 'تم توليد وتنزيل ملف PDF بنجاح',
    'settingsScannerHeader': 'إعدادات الماسح الضوئي',
    'settingsPrecisionScanTitle': 'نافذة المسح الدقيقة',
    'settingsPrecisionScanSubtitle': 'مسح الرموز المحاذية لمركز محدد فقط',
    ...
    'errorLoadingInventory': 'خطأ في تحميل المخزون',
    'qrGenAllRoomProducts': 'جميع المنتجات في الغرفة المحددة',
    'qrGenAllInventoryProducts': 'جميع المنتجات في المخزون',
    'qrLabelScanInstructions': 'امسح بتطبيق IVRA لإعادة التعبئة أو الاستبدال',
    'roomsSearchProductPlaceholder': 'البحث عن منتج بالاسم أو SKU...',
    'adjustStockForProduct': 'تعديل مخزون المتجر لـ {product}',
    ...
    'productsLabelLowStock': 'تنبيه انخفاض مخزون المتجر',
    'productsBtnEdit': 'تعديل المنتج',
    'productsLabelSku': 'وحدة حفظ مخزون المتجر (SKU)',
    ...
    'inventoryNoItemsToAdjust': 'لا توجد عناصر مخزون المتجر متاحة للتعديل.',
    'inventoryNoInventoryYet': 'لا يوجد مخزون المتجر بعد',
    'inventoryNoProductsInInventory': 'لا توجد منتجات في مخزون المتجر.',
    'inventoryNoSuggestedOrders': 'لا توجد طلبات مقترحة',
    'inventoryLevelsSufficient': 'مستويات مخزون المتجر لديك كافية حاليًا.',
    ...
    'approvalsReject': 'رفض',
    'approvalsActionFailed': 'فشل الإجراء. حاول مر�� أخرى.',
    ...
    'syncActionStockAdjustment': 'تعديل مخزون المتجر',
    ...
    'pdfTitleInventorySnapshot': 'مخزون المتجر Ivra',
    'pdfTitleRefillHistory': 'سجل تعبئة Ivra',
    'pdfTitleOpenAlerts': 'تنبيهات Ivra المفتوحة',
    'productHistoryTitle': 'سجل المنتج',
    'productHistoryNoHistory': 'لا يوجد سجل مسجل لهذا المنتج.',
    'productHistoryRefill': 'تمت إعادة التعبئة في الغرفة {roomNumber}',
    'productHistoryReplacement': 'تم استبدال الزجاجة في الغرفة {roomNumber}',
    'productHistoryAdjustment': 'تعديل مخزون المتجر يدويًا',
    'productHistoryActionBy': 'بواسطة {user}',
    'productHistoryReason': 'السبب: {reason}',
    'productHistoryDeltaFullBottles': 'زجاجات ممتلئة',
    'productHistoryDeltaUsedBottles': 'زجاجات مستعملة',
    'productHistoryDeltaFullBidons': 'زجاجات إعادة تعبئة ممتلئة',
    'productHistoryDeltaOpenBidons': 'زجاجات إعادة تعبئة مفتوحة',
    'productHistoryDeltaEmptyBidons': 'زجاجات إعادة تعبئة فارغة',
    'productHistoryNewBottle': 'تم وضع زجاجة جديدة في الغرفة {roomNumber}',
    'productHistoryFilterAll': 'الكل',
    'productHistoryFilterRoom': 'عمليات الغرف',
    'productHistoryFilterManual': 'التعديلات',
    'productHistoryStatRefills': 'إعادات التعبئة',
    ...
    'authCategoryCore': 'العمليات الأساسية',
    'authCategoryManagement': 'الإدارة',
    'authCategoryControl': 'الرقابة والموافقات',
    'authCategoryAnalytics': 'التحليلات والبث',
    'authCategorySecurity': 'الأمان والإدارة',
    'authBulkGrantAll': 'منح الكل',
    'authBulkRevokeAll': 'إلغاء الكل',
    'authRoleCreatedSuccess': 'تم إنشاء الدور بنجاح.',
    ...
    'roleAppManager': 'مشرف التطبيق',
    'roleHotelManager': 'مدير الفندق',
    'roleHotelStaff': 'موظف الفندق',
    'permManageHotels': 'إدارة الفنادق',
    'permManageHotelsDesc': 'إنشاء وتعديل وحذف الفنادق',
    'permManageRooms': 'إدارة الغرف',
    'permManageRoomsDesc': 'إضافة وتعديل وإزالة الغرف والطوابق',
    'permManageProducts': 'إدارة المنتجات',
    'permManageProductsDesc': 'تكوين أنواع المنتجات العالمية والكتالوجات',
    'permManageTeam': 'إدارة الفريق',
    'permManageTeamDesc': 'دعوة وإدارة أعضاء الفريق والأدوار',
    ...
    'permViewAlertsDesc': 'عرض ومراقبة تنبيهات العمليات',
    'permViewReports': 'عرض التقارير',
    'permViewReportsDesc': 'الوصول إلى تقارير التحليلات ومخططات الأداء',
    'permSendNotifications': 'إرسال إشعارات الهاتف',
    'permSendNotificationsDesc': 'إنشاء وبث إشعارات الهاتف للتطبيق',
    'permViewAuditLogs': 'عرض سجلات التدقيق الأمني',
    'permViewAuditLogsDesc': 'فحص سجلات العمليات وتاريخ تسجيل الدخول المفصلة',
    'permViewRooms': 'عرض الغرف',
    'permViewRoomsDesc': 'عرض قائمة وحالات إعادة تعبئة الغرف وتفاصيلها',
    ...
    'dialogRefillAdded': 'السائل المضاف حديثًا:',
    'dialogRefillNotes': 'ملاحظات (اختياري)',
    'dialogRefillConfirm': 'تأكيد إعادة التعبئة',
    'femmeDeChambre': 'عاملة الغرف',
    'checkoutStock': 'صرف مخزون',
    'returnStock': 'إرجاع مخزون',
    'housekeeperCart': 'عربتي',
    'noAllocations': 'لا توجد حصص نشطة. قم بصرف مخزون للبدء.',
    'fullBottles': 'زجاجات كاملة',
    'openBidonVolumeLeft': 'الحجم المتبقي',
    'housekeeperStockCheckedOut': 'تم صرف المخزون بنجاح!',
    'housekeeperStockReturned': 'تم إرجاع المخزون بنجاح!',
    'housekeeperStockHistory': 'السجل',
    'housekeeperStockHistoryEmpty': 'لا توجد حركات مسجلة لهذا المنتج بعد.',
    'stockEventCheckout': 'مأخوذ من مخزون الفندق',
    'stockEventReturn': 'أُعيد إلى مخزون الفندق',
    ...
    'roomsSelectProduct': 'اختر المنتج',
    'myBasket': 'عربتي',
    'housekeepersTitle': 'عاملات النظافة',
    'allHistory': 'كل السجل',
    'changePicture': 'تغيير الصورة',
    'inviteHousekeeper': 'دعوة عاملة نظافة',
    'removeHousekeeper': 'حذف',
    'basketContent': 'محتوى العربة',
    'noHousekeepers': 'لم يتم العثور على عاملات نظافة',
    'btnClose': 'إغلاق',
    'deleteGeneric': 'حذف',
    'teamDeactivate': 'تعطيل',
    'teamReactivate': 'تفعيل',
    'event_checkout': 'صرف مخزون',
    'event_returned': 'إرجاع مخزون',
    'event_roomPlacement': 'وُضع في الغرفة',
    'event_refillUse': 'استُخدم لإعادة التعبئة',
    'event_replaceUse': 'استُخدم لاستبدال الزجاجة',
    'dialogRefillNotesHint': 'مثال: تعبئة قياسية...',
    'dateFormatHint': 'سنة-شهر-يوم',
    'errorWithArgs': 'خطأ: {error}',
    'teamHotelSubtitle': '{city}، {country}',
    'productEventTitle': '{productName} - {eventLabel}',
    'chipLabelValue': '{label}: {value}',
    'productSkuLabel': '{label} ({sku})',
  ...
  'it': {
    ...
    'appThemeStyle': 'Tema e stile visivo',
    'appThemeStyleSubtitle': 'Aspetto globale per tutto il personale e i manager su tutti i dispositivi',
    'themeSolarInfusion': 'Infusione Solare',
    'themeSolarInfusionDesc': 'Calda tavolozza di ambra mediterranea e crema solare con tipografia Plus Jakarta Sans.',
    'themeBotanicalHaute': 'Alta Botanica',
    'themeBotanicalHauteDesc': 'Tavolozza di lusso smeraldo di mezzanotte e alabastro puro con tipografia architettonica Outfit.',
    'themeActive': 'Attivo',
    'themeSwitchSuccess': 'Tema dell\'app modificato a livello globale in {themeName}',
    'percentageRefillTitle': 'Ricarica in percentuale',
    'percentageRefillSubtitle': 'Consenti la registrazione dei livelli di ricarica in percentuale (1-100%)',
    ...
    'myCompletedTasksThisWeek': 'Le mie ricariche completate questa settimana',
    ...
    'inventoryTableFullBidonsGeneric': 'Bottiglie di ricarica piene',
    'inventoryTableOpenBidons': 'Bottiglie di ricarica usate',
    ...
    'bottleStatusRefilled': 'Ricaricata',
    'bottleStatusRefillLimitReached': 'Limite ricarica raggiunto',
    'bottleStatusTooOld': 'Troppo vecchia',
    'bottleStatusNeedsReplacement': 'Da sostituire',
    'bottleStatusRecycled': 'Riciclata',
    'bottleStatusDamaged': 'Danneggiata',
    'bottleStatusLost': 'Persa',
    ...
    'roomsBtnRefillBottle': 'Ricarica bottiglia',
    'roomsBtnRoomEdit': 'Modifica camera',
    'roomsBtnHistory': 'Cronologia',
    'roomsBtnMoreActions': 'Altre azioni',
    'roomsBtnMarkDamaged': 'Segnala come danneggiata',
    'roomsBtnMarkLost': 'Segnala come persa',
    'roomsLabelProofPhoto': 'Foto di prova',
    'roomsNotesOptional': 'Note (Opzionale)',
    'roomsLabelUploadedProof': 'Prova caricata',
    'roomsUploadProofAction': 'Carica foto',
    ...
    'roomsHistoryStatusChanged': 'Stato modificato da {oldValue} a {newValue}',
    ...
    'btnBack': 'Indietro',
    'qrActionSuccess': 'Azione riuscita',
    'qrActionFailed': 'Azione fallita',
    'qrUpdatedStatus': 'Stato dispensatore aggiornato:',
    'qrScanAnother': 'Scansiona un altro codice QR',
    'qrReturnRooms': 'Torna alle camere',
    'qrTryScanAgain': 'Riprova la scansione',
    'qrFloorRoom': 'Piano {floor} • Camera {room}',
    'qrRoomFloor': 'Camera {room} • Piano {floor}',
    ...
    'qrGenerateHotel': 'Hotel',
    'qrGenerateScope': 'Tipo etichetta QR',
    'qrGenerateScopeRoom': 'Porta camera (senza SKU)',
    'qrGenerateScopeDispenser': 'Dispensatore (con SKU)',
    'qrGenerateRoom': 'Camera',
    'qrGenerateProduct': 'Prodotto',
    'qrGenerateAllRooms': 'Tutte le camere',
    'qrGenerateAllProducts': 'Tutti i prodotti',
    'qrGenerateBtnDownload': 'Genera & Scarica PDF',
    'qrGenerateDownloading': 'Generazione PDF...',
    ...
    'pdfTitleInventorySnapshot': 'Stato stock magazzino Ivra',
    ...
    'productHistoryDeltaFullBottles': 'Bottiglie piene',
    'productHistoryDeltaUsedBottles': 'Bottiglie usate',
    ...
    'productHistoryStatRefills': 'Ricariche',
    ...
    'authCategoryManagement': 'Gestione',
    'authCategoryControl': 'Controllo e Approvazioni',
    'authCategoryAnalytics': 'Analisi e Trasmissioni',
    'authCategorySecurity': 'Sicurezza e Amministrazione',
    'authBulkGrantAll': 'Concedi Tutto',
    'authBulkRevokeAll': 'Revoca Tutto',
    'authRoleCreatedSuccess': 'Ruolo creato con successo.',
    ...
    'roleHotelStaff': 'Personale hotel',
    'permManageHotels': 'Gestisci Hotel',
    'permManageHotelsDesc': 'Crea, modifica ed elimina proprietà dell\'hotel',
    'permManageRooms': 'Gestisci Camere',
    'permManageRoomsDesc': 'Aggiungi, modifica e rimuovi camere e piani',
    'permManageProducts': 'Gestisci Prodotti',
    'permManageProductsDesc': 'Configura tipi di prodotti globali e cataloghi',
    ...
    'dialogRefillAdded': 'Liquido appena aggiunto:',
    'dialogRefillNotes': 'Note (opzionale)',
    'dialogRefillConfirm': 'Conferma ricarica',
    'femmeDeChambre': 'Cameriera',
    'checkoutStock': 'Preleva stock',
    'returnStock': 'Ritorna stock',
    'housekeeperCart': 'Mio carrello',
    'noAllocations': 'Nessuna allocazione attiva. Preleva stock per iniziare.',
    'fullBottles': 'Bottiglie piene',
    'openBidonVolumeLeft': 'Volume rimanente',
    ...
    'roomsSelectProduct': 'Seleziona Prodotto',
    'myBasket': 'Il mio Cestino',
    'housekeepersTitle': 'Goveranti',
    'allHistory': 'Tutta la cronologia',
    'changePicture': 'Cambia foto',
    'inviteHousekeeper': 'Invita governante',
    'removeHousekeeper': 'Rimuovi',
    'basketContent': 'Contenuto del cestino',
    'noHousekeepers': 'Nessuna governante trovata',
    'btnClose': 'Close',
    'deleteGeneric': 'Delete',
    'teamDeactivate': 'Deactivate',
    'teamReactivate': 'Reactivate',
    ...
    'event_refillUse': 'Refill Used',
    'event_replaceUse': 'Bottle Replaced',
    'dialogRefillNotesHint': 'es: ricarica standard...',
    'dateFormatHint': 'AAAA-MM-GG',
    'errorWithArgs': 'Errore: {error}',
    'teamHotelSubtitle': '{city}, {country}',
    'productEventTitle': '{productName} - {eventLabel}',
    'chipLabelValue': '{label}: {value}',
    'productSkuLabel': '{label} ({sku})',
