...
class IvraIcons {
  ...
  static const IconData fullBottleWithPump = IconData(
    0xe809,
  ...
  static const IconData emptyBottleWithPump = IconData(
    0xe806,
    fontFamily: _kFontFam,
    fontPackage: _kFontPkg,
  );
  ...
  static const IconData fullBottleWithoutPump = IconData(
    0xe808,
    fontFamily: _kFontFam,
    fontPackage: _kFontPkg,
  );
  ...
  static const IconData emptyBottleWithoutPump = IconData(
    0xe805,
    fontFamily: _kFontFam,
    fontPackage: _kFontPkg,
  );
  ...
  static const IconData fullRefillBottle = IconData(
    0xe807,
    fontFamily: _kFontFam,
    fontPackage: _kFontPkg,
  );
  ...
  static const IconData emptyRefillBottle = IconData(
    0xe804,
    fontFamily: _kFontFam,
    fontPackage: _kFontPkg,
  );
  ...
  static const IconData refillAction = IconData(
    0xe803,
    fontFamily: _kFontFam,
    fontPackage: _kFontPkg,
  );
  ...
  static const IconData replaceAction = IconData(
    0xe802,
    fontFamily: _kFontFam,
    fontPackage: _kFontPkg,
  );
  ...
  static const IconData bottleVolume = IconData(
    0xe801,
    fontFamily: _kFontFam,
    fontPackage: _kFontPkg,
  );
  ...
  static const IconData refillBottleVolume = IconData(
    0xe800,
    fontFamily: _kFontFam,
    fontPackage: _kFontPkg,
  );
