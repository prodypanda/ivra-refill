-- Migration: Fix low bidon stock alerts for direct replacements and fix clear_audit_logs function for safeupdate protection.
...
begin
  ...
  -- 2. Low Bidon Stock Alerts (only for refillable products)
  insert into alerts (hotel_id, product_id, alert_type, severity, title, body)
  select
    hi.hotel_id,
    hi.product_id,
