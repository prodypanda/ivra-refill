...
void main() {
  ...
  testWidgets('ApprovalsScreen renders without errors', (WidgetTester tester) async {
  ...
  testWidgets('ApprovalsScreen Arabic RTL layout rendering without overflow', (WidgetTester tester) async {
